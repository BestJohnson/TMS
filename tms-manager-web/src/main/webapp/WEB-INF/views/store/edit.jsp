            ...
            <div class="box">
                <div class="box-body">
                    <form method="post" id="saveForm">
                        ...
                        <input type="hidden" id="managerAttachment" name="managerAttachment" value="${ticketStore.managerAttachment}">
                        ...
                        <div class="form-group">
                            <label>联系电话</label>
                            <input type="text" class="form-control" name="storeMobile" value="${ticketStore.storeMobile}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div id="picker">选择联系人身份证照片</div>
                                <div class="photo" id="managerPhoto">
                                    <img src="http://p7f6tjc1h.bkt.clouddn.com/${ticketStore.managerAttachment}-preview" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
