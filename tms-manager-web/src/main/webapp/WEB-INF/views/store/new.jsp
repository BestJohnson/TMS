...
<div class="wrapper">
    ...
    <jsp:include page="../include/sider.jsp">
        <jsp:param name="menu" value="ticketstore"/>
    </jsp:include>
                    ...
                    <form method="post" id="saveForm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="photo" id="managerPhoto"></div>
                            </div>
                            <div class="col-md-6">
...
<script>
    $(function () {
        ...
        var uploader = WebUploader.create({
            ...
            //文件接收服务端
            server : 'http://uploader-z1.qiniup.com',
            //上传文件类型，使用七牛必须为file
            fileVal: 'file',
            //返回给七牛的token令牌
            formData:{
        ...
        uploader.on( 'uploadSuccess', function( file,response ) {
            ...
            var $img = $("<img>").attr("src","（七牛给你的域名）http://p7f6tjc1h.bkt.clouddn.com/"+fileName+"（图片处理）-preview");
            $img.appendTo($("#managerPhoto"));
            //将key存放到隐藏域中
            $("#managerAttachment").val(fileName);
            layer.msg("上传成功");
        });
