                ...
                <div class="box-body">
                    <table class="table">
                        ...
                        <c:forEach items="${ticketInRecordList}" var="ticketInRecord">
                            <tr>
                                <td><fmt:formatDate value="${ticketInRecord.createTime}" timeStyle="YYYY-MM-dd"/> </td>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-xs" href="/ticket/${ticketInRecord.id}/edit" title="编辑"><i class="fa fa-pencil"></i></a>
